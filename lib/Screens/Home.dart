              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      " " +
                          getTranslated(context, OrderNumber)! +
                          ": " +
                          model.orderDate!,
                    ),
                  ],
      ...
      if (response.statusCode == 200) {
        ...
        if (!error) {
          ...
          SUPPORTED_LOCALES = getdata["supported_locals"] != "" &&
              ...
              : "hi";
          if (getdata["system_settings"].toString().contains(MAINTAINANCE_MODE)) {
          ...
          if (getdata["system_settings"].toString().contains(MAINTAINANCE_MESSAGE)) {
            IS_APP_MAINTENANCE_MESSAGE = getdata["system_settings"][MAINTAINANCE_MESSAGE];
          }
          if (Is_APP_IN_MAINTANCE == "1") {
            ...
            child: AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  IS_APP_MAINTENANCE_MESSAGE != ''?Text(
